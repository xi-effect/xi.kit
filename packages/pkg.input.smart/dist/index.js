...
var require_clsx = __commonJS({
  "../pkg.icons/node_modules/clsx/dist/clsx.js"(exports2, module2) {
    ...
    module2.exports = r2, module2.exports.clsx = r2;
  }
});
...
var require_dist = __commonJS({
  "../pkg.icons/node_modules/class-variance-authority/dist/index.js"(exports2) {
    ...
    var falsyToString2 = (value) => typeof value === "boolean" ? "".concat(value) : value === 0 ? "0" : value;
    var cx2 = _clsx.clsx;
    exports2.cx = cx2;
    var cva2 = (base, config) => {
      return (props) => {
        var ref;
        if ((config === null || config === void 0 ? void 0 : config.variants) == null) return cx2(base, props === null || props === void 0 ? void 0 : props.class, props === null || props === void 0 ? void 0 : props.className);
        const { variants, defaultVariants } = config;
        const getVariantClassNames = Object.keys(variants).map((variant) => {
          const variantProp = props === null || props === void 0 ? void 0 : props[variant];
          const defaultVariantProp = defaultVariants === null || defaultVariants === void 0 ? void 0 : defaultVariants[variant];
          if (variantProp === null) return null;
          const variantKey = falsyToString2(variantProp) || falsyToString2(defaultVariantProp);
...
var require_dist2 = __commonJS({
  "../pkg.icons/dist/index.js"(exports2, module2) {
    ...
    var import_class_variance_authority2 = require_dist();
    var import_utils6 = require("@xipkg/utils");
    var import_jsx_runtime2 = require("react/jsx-runtime");
    var svgVariants = (0, import_class_variance_authority2.cva)("", {
      variants: {
        theme: {
    ...
    var Svg = (_a) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", __spreadProps2(__spreadValues2({ viewBox: "0 0 24 24", className: (0, import_utils6.cn)(svgVariants({ theme, size, className })) }, rest), { children }));
    };
...
__export(index_exports, {
  ...
  markdownToSlate: () => markdownToSlate,
...
var Leaf = ({ attributes, children, leaf }) => {
  ...
  if (leaf.bold) {
    modifiedChildren = /* @__PURE__ */ import_react.default.createElement("strong", null, modifiedChildren);
  }
  if (leaf.italic) {
    modifiedChildren = /* @__PURE__ */ import_react.default.createElement("em", null, modifiedChildren);
  }
  if (leaf.underline) {
    modifiedChildren = /* @__PURE__ */ import_react.default.createElement("u", null, modifiedChildren);
  }
  if (leaf.strikethrough) {
    modifiedChildren = /* @__PURE__ */ import_react.default.createElement("span", { style: { textDecoration: "line-through" } }, modifiedChildren);
  }
  if (leaf.code) {
    modifiedChildren = /* @__PURE__ */ import_react.default.createElement(
      "code",
      {
  ...
  return /* @__PURE__ */ import_react.default.createElement("span", __spreadValues({}, attributes), modifiedChildren);
};

// components/InlineToolbar.tsx
var import_react4 = __toESM(require("react"));
var import_slate_react2 = require("slate-react");
var import_icons = __toESM(require_dist2());
...
var Slot = React3.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlotClone, __spreadProps(__spreadValues({}, slotProps), { ref: forwardedRef, children: React3.isValidElement(newElement) ? React3.cloneElement(newElement, void 0, newChildren) : null }));
  }
...
var Button = React4.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React4.createElement(Comp, __spreadValues({ className: (0, import_utils.cn)(buttonVariants({ variant, size, className })), ref }, props), children);
  }
);
...
function useTooltip({
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = React5.useState(initialOpen);
  ...
  const { delay } = (0, import_react2.useDelayGroupContext)();
  ...
  const focus = (0, import_react2.useFocus)(context, {
    enabled: controlledOpen == null
  });
  const dismiss = (0, import_react2.useDismiss)(context);
  const role = (0, import_react2.useRole)(context, { role: "tooltip" });
  const interactions = (0, import_react2.useInteractions)([hover, focus, dismiss, role]);
...
var useTooltipState = () => {
  const context = React5.useContext(TooltipContext);
  if (context == null) {
...
function Tooltip(_a) {
  ...
  return /* @__PURE__ */ React5.createElement(TooltipContext.Provider, { value: tooltip }, children);
}
var TooltipTrigger = React5.forwardRef((_a, propRef) => {
  var _b = _a, { children, asChild = false } = _b, props = __objRest(_b, ["children", "asChild"]);
  const state = useTooltipState();
  const childrenRef = children.ref;
  const ref = (0, import_react2.useMergeRefs)([state.refs.setReference, propRef, childrenRef]);
...
var TooltipContent = React5.forwardRef(
  (props, propRef) => {
    const state = useTooltipState();
    const { isInstantPhase, currentId } = (0, import_react2.useDelayGroupContext)();
    const ref = (0, import_react2.useMergeRefs)([state.refs.setFloating, propRef]);
    (0, import_react2.useDelayGroup)(state.context, { id: state.context.floatingId });
    const instantDuration = 0;
    const duration = 250;
    const { isMounted, styles } = (0, import_react2.useTransitionStyles)(state.context, {
    ...
    return /* @__PURE__ */ React5.createElement(import_react2.FloatingPortal, null, /* @__PURE__ */ React5.createElement(
      "div",
      __spreadValues({
        ref,
...
var markdownToSlate = (markdown) => {
  const ast = (0, import_unified.unified)().use(import_remark_parse.default).use(import_remark_gfm.default).parse(formatMarkdown(markdown));
  const slateElements = [];
  visit(ast, (node) => {
...
var toggleMarkdownInlineStyle = (editor, marker, debug = process.env.ENABLE_SLATE_TESTING === "true") => {
  ...
  if (!selection || import_slate.Range.isCollapsed(selection) || !marker) {
    return;
  }
  ...
  const textBefore = import_slate.Editor.string(editor, rangeBefore);
  const textAfter = import_slate.Editor.string(editor, rangeAfter);
  if (debug) {
  ...
  if (textBefore === marker && textAfter === marker) {
    ...
    import_slate.Transforms.delete(editor, { at: rangeAfter });
    import_slate.Transforms.delete(editor, { at: rangeBefore });
    const newSelection = {
    ...
    import_slate.Transforms.select(editor, newSelection);
  } else {
    const selectedText = import_slate.Editor.string(editor, selection);
    ...
    if (startMarkerIdx !== -1 && endMarkerIdx !== -1 && startMarkerIdx !== endMarkerIdx) {
      ...
      import_slate.Transforms.delete(editor, { at: selection });
      if (debug) {
        console.log("editor", editor);
        console.log("textWithoutMarkers", textWithoutMarkers);
        console.log("start", start);
      }
      import_slate.Transforms.insertText(editor, textWithoutMarkers, { at: start });
      ...
      import_slate.Transforms.select(editor, correctedSelection);
    } else {
      import_slate.Transforms.insertText(editor, marker, { at: end });
      import_slate.Transforms.insertText(editor, marker, { at: start });
      const correctedSelection = {
        anchor: __spreadProps(__spreadValues({}, currentSelection.anchor), {
          offset: currentSelection.anchor.offset + marker.length
        }),
...
var InlineToolbar = ({ editableRef }) => {
  const editor = (0, import_slate_react2.useSlate)();
  const [isOpen, setIsOpen] = (0, import_react4.useState)(false);
  const [initialPosition, setInitialPosition] = (0, import_react4.useState)(null);
  const { refs, floatingStyles, context } = (0, import_react5.useFloating)({
    placement: "top",
    open: isOpen,
    onOpenChange: setIsOpen,
    middleware: [(0, import_react5.flip)(), (0, import_react5.shift)(), (0, import_react5.inline)()],
    whileElementsMounted: import_react5.autoUpdate
  });
  const dismiss = (0, import_react5.useDismiss)(context);
  const { getFloatingProps } = (0, import_react5.useInteractions)([dismiss]);
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, isOpen && /* @__PURE__ */ import_react4.default.createElement(import_react5.FloatingFocusManager, { initialFocus: -1, context }, /* @__PURE__ */ import_react4.default.createElement(
    "div",
    __spreadProps(__spreadValues({
    ...
    /* @__PURE__ */ import_react4.default.createElement(import_react5.FloatingDelayGroup, { delay: { open: 1500, close: 0 } }, /* @__PURE__ */ import_react4.default.createElement(Tooltip, { placement: "bottom" }, /* @__PURE__ */ import_react4.default.createElement(TooltipTrigger, null, /* @__PURE__ */ import_react4.default.createElement(
      FormatButton,
      {
        format: "**" /* Bold */,
        icon: /* @__PURE__ */ import_react4.default.createElement(import_icons.Bold, { className: "group-hover:fill-brand-100 h-4 w-4 fill-gray-100" })
      }
    )), /* @__PURE__ */ import_react4.default.createElement(TooltipContent, null, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("p", null, /* @__PURE__ */ import_react4.default.createElement("b", null, "Bold")), /* @__PURE__ */ import_react4.default.createElement("p", null, "Ctrl+B")))), /* @__PURE__ */ import_react4.default.createElement(Tooltip, { placement: "bottom" }, /* @__PURE__ */ import_react4.default.createElement(TooltipTrigger, null, /* @__PURE__ */ import_react4.default.createElement(
      FormatButton,
      {
        format: "*" /* Italic */,
        icon: /* @__PURE__ */ import_react4.default.createElement(import_icons.Italic, { className: "group-hover:fill-brand-100 h-4 w-4 fill-gray-100" })
      }
    )), /* @__PURE__ */ import_react4.default.createElement(TooltipContent, null, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("p", null, /* @__PURE__ */ import_react4.default.createElement("i", null, "Italicize")), /* @__PURE__ */ import_react4.default.createElement("p", null, "Ctrl+I")))), /* @__PURE__ */ import_react4.default.createElement(Tooltip, { placement: "bottom" }, /* @__PURE__ */ import_react4.default.createElement(TooltipTrigger, null, /* @__PURE__ */ import_react4.default.createElement(
      FormatButton,
      {
        format: "__" /* Underline */,
        icon: /* @__PURE__ */ import_react4.default.createElement(import_icons.Underline, { className: "group-hover:fill-brand-100 h-4 w-4 fill-gray-100" })
      }
    )), /* @__PURE__ */ import_react4.default.createElement(TooltipContent, null, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("p", null, /* @__PURE__ */ import_react4.default.createElement("u", null, "Underline")), /* @__PURE__ */ import_react4.default.createElement("p", null, "Ctrl+U")))), /* @__PURE__ */ import_react4.default.createElement(Tooltip, { placement: "bottom" }, /* @__PURE__ */ import_react4.default.createElement(TooltipTrigger, null, /* @__PURE__ */ import_react4.default.createElement(
      FormatButton,
      {
        format: "~~" /* Strikethrough */,
        icon: /* @__PURE__ */ import_react4.default.createElement(import_icons.Stroke, { className: "group-hover:fill-brand-100 h-4 w-4 fill-gray-100" })
      }
    )), /* @__PURE__ */ import_react4.default.createElement(TooltipContent, null, /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("p", null, /* @__PURE__ */ import_react4.default.createElement("s", null, "Strike-through")), /* @__PURE__ */ import_react4.default.createElement("p", null, "Ctrl+S")))))
  )));
};
var FormatButton = ({
  format,
...
var MarkdownPreview = ({ markdown }) => {
  ...
  return /* @__PURE__ */ import_react6.default.createElement(
    import_react_markdown.default,
    {
      ...
      rehypePlugins: [import_rehype_raw.default, [import_rehype_react.default, { createElement: import_react6.default.createElement }]],
      components: {
        a(props) {
          const _a = props, { node } = _a, rest = __objRest(_a, ["node"]);
          return /* @__PURE__ */ import_react6.default.createElement(CustomLink, __spreadValues({}, rest));
        },
        u({ children }) {
          return /* @__PURE__ */ import_react6.default.createElement("u", null, children);
        },
        strong({ children }) {
          return /* @__PURE__ */ import_react6.default.createElement("strong", null, children);
        }
      }
    },
    formattedMarkdown
...
var import_prism_markdown = require("prismjs/components/prism-markdown");
var import_utils3 = require("@xipkg/utils");
import_prismjs2.default.languages.markdown = prismMarkdown;
var SmartInput = ({
  editorRef,
  initialValue,
  onChange,
  ...
  const editor = (0, import_react7.useMemo)(() => (0, import_slate_history.withHistory)((0, import_slate_react3.withReact)((0, import_slate2.createEditor)())), []);
  const decorate = (0, import_react7.useCallback)(([node, path]) => {
    const ranges = [];
    if (!import_slate2.Text.isText(node)) {
      return ranges;
    }
    const tokens = import_prismjs2.default.tokenize(node.text, import_prismjs2.default.languages.markdown);
    let start = 0;
  ...
  const handleCopy = (0, import_react7.useCallback)(
    (event) => {
      ...
      if (selection) {
        const value = import_slate2.Editor.fragment(editor, selection);
  ...
  const handlePaste = (0, import_react7.useCallback)(
    (event) => {
      ...
      import_slate2.Transforms.insertText(editor, pastedText, { at: editor.selection });
      event.preventDefault();
    },
    [editor]
  );
  ...
  const editableRef = (0, import_react7.useRef)(null);
  (0, import_react7.useImperativeHandle)(editorRef, () => __spreadProps(__spreadValues({}, editor), {
    resetContent: () => {
      editor.children = [
        {
          type: "paragraph",
    ...
    focus: () => {
      ...
      if (!editor.selection) {
        const end = import_slate2.Editor.end(editor, []);
        import_slate2.Transforms.select(editor, end);
      }
    }
  }));
    ...
    (event) => {
      if (event.key === "Enter") {
        if (!event.shiftKey) {
          ...
          event.preventDefault();
          import_slate2.Transforms.insertNodes(editor, {
            type: "paragraph",
            children: [{ text: "" }]
          });
        }
  ...
  return /* @__PURE__ */ import_react7.default.createElement(
    ...
    /* @__PURE__ */ import_react7.default.createElement(InlineToolbar, { editableRef }),
    /* @__PURE__ */ import_react7.default.createElement(
      import_slate_react3.Editable,
      __spreadValues({
        ref: editableRef,
        decorate,
        ...
        renderLeaf: (_a) => {
          ...
          return /* @__PURE__ */ import_react7.default.createElement(Leaf, __spreadValues({ leaf }, props));
        },
