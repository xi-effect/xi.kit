...
export const buttonVariants = cva(
  'inline-flex items-center w-[300px] justify-center ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-brand-80 font-gray-0 dark:text-gray-0 hover:bg-brand-100 active:bg-brand-100 focus:bg-brand-100',
