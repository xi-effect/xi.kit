...
var Switch = React.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwitchPrimitives.Root, __spreadProps(__spreadValues({ className: toggleVariants({ size, className }) }, props), { ref, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwitchPrimitives.Thumb, { className: toggleThumbVariants({ size }) }) }));
  }
);
