...
var SheetContent = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetPrimitive.Content, __spreadProps(__spreadValues({ ref, className: (0, import_utils.cn)(sheetVariants({ side }), className) }, props), { children })) });
});
SheetContent.displayName = SheetPrimitive.Content.displayName;
var SheetHeader = (_a) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", __spreadValues({ className: (0, import_utils.cn)("flex flex-col space-y-2 text-center sm:text-left", className) }, props));
};
...
var SheetFooter = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    __spreadValues({
      className: (0, import_utils.cn)("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className)
    }, props)
  );
};
