...
var SheetContent = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsx(SheetPortal, { children: /* @__PURE__ */ jsx(SheetPrimitive.Content, __spreadProps(__spreadValues({ ref, className: cn(sheetVariants({ side }), className) }, props), { children })) });
});
