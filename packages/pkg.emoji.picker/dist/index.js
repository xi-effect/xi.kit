...
var import_button2 = require("@xipkg/button");
var import_dropdown = require("@xipkg/dropdown");
var import_icons = require("@xipkg/icons");
var import_input = require("@xipkg/input");
var import_utils2 = require("@xipkg/utils");

// EmojiCategory.tsx
var import_react3 = require("react");
var import_button = require("@xipkg/button");
...
var useVisibleRows = (containerRef, categoryRef, totalRows, rowHeight, bufferRows) => {
  const [visibleRows, setVisibleRows] = (0, import_react2.useState)([0, 0]);
...
var EmojiCategory = (0, import_react3.memo)(
  ({
    currentIndex,
    ...
    const categoryRef = (0, import_react3.useRef)(null);
    ...
    const visibleEmojis = (0, import_react3.useMemo)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { id: `emoji-category-${currentIndex}`, ref: categoryRef, className: "mb-4", children: [
      category.name_rus && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bg-gray-0 pb-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h6", { className: "text-s-base first-letter:uppercase", children: category.name_rus }) }),
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              ...
              children: visibleEmojis.map((emoji) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
// EmojiPicker.tsx
var import_tooltip = require("@xipkg/tooltip");
var import_jsx_runtime2 = require("react/jsx-runtime");
var recentIcon = { icon: import_icons.Clock, name: "\u041F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0435" };
var categoryIcons = [
  { icon: import_icons.Emotions, name: "\u041B\u0438\u0446\u0430 \u0438\xA0\u044D\u043C\u043E\u0446\u0438\u0438" },
  { icon: import_icons.Nature, name: "\u041F\u0440\u0438\u0440\u043E\u0434\u0430" },
  { icon: import_icons.Food, name: "\u0415\u0434\u0430\xA0\u0438\xA0\u043D\u0430\u043F\u0438\u0442\u043A\u0438" },
  { icon: import_icons.Activity, name: "\u0410\u043A\u0442\u0438\u0432\u043D\u043E\u0441\u0442\u0438" },
  { icon: import_icons.Places, name: "\u041F\u0443\u0442\u0435\u0448\u0435\u0441\u0442\u0432\u0438\u044F \u0438\xA0\u043C\u0435\u0441\u0442\u0430" },
  { icon: import_icons.Objects, name: "\u041E\u0431\u044A\u0435\u043A\u0442\u044B" },
  { icon: import_icons.Heart, name: "\u0421\u0438\u043C\u0432\u043E\u043B\u044B" },
  { icon: import_icons.Flag, name: "\u0424\u043B\u0430\u0433\u0438" }
];
var EmojiPicker = ({ recentEmojis, onEmojiSelect }) => {
  const [activeCategoryIndex, setActiveCategoryIndex] = (0, import_react4.useState)(0);
  ...
  const filteredCategories = (0, import_react4.useMemo)(() => {
  ...
  const matchedEmojis = (0, import_react4.useMemo)(() => {
  ...
  const emojiCategories = (0, import_react4.useMemo)(() => {
    if (!categories) {
      return [];
    }
  ...
  const handleEmojiClick = (0, import_react4.useCallback)(
    (emoji) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_dropdown.DropdownMenu, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dropdown.DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_button2.Button, { variant: "ghost", className: "bg-gray-0 h-auto rounded-[4px] p-1", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_icons.Emotions, {}) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dropdown.DropdownMenuContent, { className: "p-0", align: "end", sideOffset: 8, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex h-[296px] w-[276px] rounded-lg", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-gray-5 flex flex-col gap-2 p-2", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_tooltip.TooltipProvider, { children: emojiCategoriesIcons.map(({ icon: Icon, name }, index) => {
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_tooltip.Tooltip, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_tooltip.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_tooltip.TooltipContent, { side: "right", className: "z-[99]", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: name }) })
        ] }, index);
      }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bg-gray-0 flex w-full flex-col gap-2 p-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_input.Input,
          {
            variant: "s",
            before: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_icons.Search, { size: "s" }),
            placeholder: "\u041F\u043E\u0438\u0441\u043A",
            className: "border",
            value: searchQuery,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "div",
          {
            ...
            children: filteredCategories && searchQuery ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              EmojiCategory,
              {
            ...
            ) : emojiCategories.length > 0 && emojiCategories.map((emojis, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              EmojiCategory,
              {
                setActiveCategory: setActiveCategoryIndex,
                category: emojis,
