...
var RadioGroup = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupPrimitive.Root, __spreadProps(__spreadValues({ className: (0, import_utils.cn)("grid gap-2", className) }, props), { ref }));
});
