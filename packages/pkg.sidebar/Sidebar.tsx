...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@xipkg/sheet';
        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-[--sidebar-width-icon]x group-data-[side=right]:border-l',
            className,
          )}
          {...props}
        >
...
>(({ className, ...props }) => {
  return <Input data-sidebar="input" className={cn('h-8 w-full', className)} {...props} />;
});
