...
export const modalOverlayVariants = cva(
  'border-gray-5 flex flex-col space-y-2 border-b p-6 max-sm:p-4 text-left bg-gray-0',
  {
    variants: {
      overlayVariant: {
        default:
          'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-gray-100/40 flex overflow-y-auto py-10 border-b-0',
