...
const DialogCloseButton = ({ variant, className, children, ...props }: DialogCloseButtonProps) => (
  <DialogPrimitive.Close className={cn(dialogCloseButtonVariants({ variant, className }))} {...props}>
    {children}
