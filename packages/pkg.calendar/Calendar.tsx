...
const rangeBetweenButtonStyles = cn(
  ...
  '[&.xipkg-calendar-range-middle]:[&_button]:hover:!bg-brand-40',
  '[&.xipkg-calendar-range-middle]:[&_button]:focus:!bg-brand-40',
  'dark:[&.xipkg-calendar-range-middle]:[&_button]:!bg-brand-0',
