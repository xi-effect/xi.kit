...
var import_calendar = require("@xipkg/calendar");
...
// DatePicker.tsx
var import_popover = require("@xipkg/popover");
...
var DatePicker = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_popover.Popover, __spreadProps(__spreadValues({}, popoverProps), { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popover.PopoverTrigger, __spreadProps(__spreadValues({ className: classNamePopoverTrigger, asChild: true }, popoverTriggerProps), { children })),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_popover.PopoverContent,
      __spreadProps(__spreadValues({
        className: (0, import_utils.cn)("w-auto p-0", classNamePopoverContent)
      }, popoverContentProps), {
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_calendar.Calendar, __spreadProps(__spreadValues({}, calendarProps), { locale: ru }))
      })
    )
  ] }));
};
