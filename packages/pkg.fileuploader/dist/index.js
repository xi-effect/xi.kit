...
var Spinner = ({ className, size = 16 }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...
      role: "status",
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]", children: "Loading..." })
    }
  );
};
...
var Tooltip = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "absolute right-[-10px] top-[50%] translate-x-[100%] translate-y-[-50%]", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "div",
    {
      className: cx(
...
var File = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: containerStyles({ size }), children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "p",
      {
        ...
        children: [
          error && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-gray-100", children: "\u0412\u044B\u0431\u0440\u0430\u043D \u0444\u0430\u0439\u043B" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Tooltip_default, { className: "hidden group-hover:block", text: error })
          ] }),
          " ",
          name
        ]
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "f-4 flex w-4 shrink-0 items-center justify-center [&_svg]:h-full [&_svg]:w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "group-hover:hidden", children: isSucceeded && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_icons.Check, {}) || isPending && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Spinner_default, {}) }),
      onDeleteClick && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "button",
        {
          className: (0, import_utils2.cn)(
          ...
          onClick: handleClose,
          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_icons.Close, {})
        }
      )
    ] })
  ] });
...
// FileUploader.tsx
var import_icons2 = require("@xipkg/icons");
var import_utils4 = require("@xipkg/utils");
...
var FileUploader = (_a) => {
  ...
  const dragDeph = (0, import_react.useRef)(0);
  const id = (0, import_react.useId)();
  const isLarge = size === "large";
  const formatedSizeLimit = (0, import_utils4.formatBytesSize)(bytesSizeLimit);
  const handleDrop = (e) => {
    stopDefaultEvents(e);
    setIsDragOver(false);
  ...
  const handleFilesChange = (files) => {
    ...
    if (fileList.length > limit || !validateSize(fileList, bytesSizeLimit)) {
      return setError(
        `\u041C\u043E\u0436\u043D\u043E \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u043D\u0435\xA0\u0431\u043E\u043B\u0435\u0435 ${limit} ${(0, import_utils4.plural)(
          pluralFiles,
          limit
  ...
  const fileInput = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "input",
    __spreadValues({
      id,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { htmlFor: id, className: disabled ? "" : "cursor-pointer", children: children ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      children,
      fileInput
      ...
      "div",
      {
        ...
        children: [
          fileInput,
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: titleStyles({ isDragOver, size, isDisabled: disabled }), children: isLarge ? "\u041F\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0442\u0435 \u0441\u044E\u0434\u0430 \u0438\u043B\u0438\xA0\u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0444\u0430\u0439\u043B" : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-gray-90 group-hover:text-gray-100", children: "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0444\u0430\u0439\u043B" }),
            " \u0438\u043B\u0438 \u043F\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0442\u0435 \u0441\u044E\u0434\u0430"
          ] }) }),
          isLarge && fileTypesHint && withLargeError && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "group-hover:text-brand-60 text-brand-40 text-center text-xs", children: descriptionText || `${fileTypesHint.map((el) => el.toUpperCase()).join(", ")} \u0434\u043E ${formatedSizeLimit}` }),
          !isLarge && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_icons2.Upload, { className: "ml-auto" })
        ]
      }
    ) }),
    error && withError && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "mt-4 text-sm leading-5 text-gray-100", children: error })
  ] });
};
