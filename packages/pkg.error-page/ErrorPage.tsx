  ...
  <main className="3xl:mx-[360px] mx-8 flex h-[100vh] md:mx-[60px] lg:mx-[120px]">
    ...
    <div className="flex flex-col justify-center">
      <span className="flex flex-col-reverse sm:flex-row sm:gap-1">
        <h1 className="text-text-primary mb-4 text-[40px] font-bold sm:text-[48px] xl:text-[64px]">
          {title}
        </h1>
        <span className="text-text-disabled text-[28px] font-bold xl:text-[40px]">{errorCode}</span>
      </span>
      <p className="text-text-primary mb-16 text-[20px] font-normal sm:text-[24px] xl:text-[30px]">
        {text}
      </p>
      <p className="text-text-secondary text-[16px]">
        ...
        <span className="flex flex-col sm:flex-row">
          <span className="flex items-center">
            в&nbsp;
            <TelegramFilled size="s" className="fill-icon-brand mr-1" />
          ...
          <span className="flex items-center">
            &nbsp;или&nbsp;
            <MailRounded size="s" className="fill-icon-brand mr-1" />
      ...
      {additionalText && (
        <div className="text-text-secondary mt-[64px] text-[16px]">{additionalText}</div>
      )}
    </div>
  </main>
);
